...
static NSString *const kChesscoinFeedbackCaption = @"Chesscoin iOS Feedback";
...
- (void)showFeedbackController:(UIViewController *)parentViewController {
    if ([MFMailComposeViewController canSendMail]) {
        ...
        NSString *path = [NSString
                          stringWithFormat:@"/&subject=%@&body=%@", kChesscoinFeedbackCaption, [self getDefaultFeedbackTextBody]];
        NSURL *mailUrl = [[NSURL alloc] initWithScheme:@"mailto" host:@"Chesscoinios@gmail.com?" path:path];
...
- (MFMailComposeViewController *)createFeedbackMailController {
    ...
    [controller setToRecipients:[NSArray arrayWithObject:@"Chesscoinios@gmail.com"]];
    [controller setSubject:kChesscoinFeedbackCaption];
